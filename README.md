...
Basic Facts: List of basic statistics about Earth, such as its polar diameter, mass, and moons.

Top 3 Facts: A list of three interesting facts about Earth.

Planet Comparison Table: A table comparing Earth with Mars and Venus, displaying their radius and average temperature.

External Link: A form that links to a Wikipedia page for further reading about Earth.
...
Earth Image.jpg: Image of Earth that is displayed on the webpage (make sure the file is placed in the same directory).
...
Open the index.html file in any web browser (Google Chrome, Firefox, Safari, etc.).
